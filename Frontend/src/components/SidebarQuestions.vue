                    ...
                    <div v-for="(q, qIndex) in section.questions"
                        ...
                        <span class="question-text">
                            <i v-if="section.id === 'autogenerated-questions' && isRegenerating"
                               :class="['fa', 'fa-ellipsis', 'fa-beat-fade']"
                            />
        ...
        async autogenerateSampleQuestions(numQuestions = 5) {
            try {
                ...
                const newQuestions = {
                    ...
                    "icon": "🪄",
                    "questions": Array(numQuestions).fill({"question": "", "icon": ""})
                };
                ...
                newQuestions.questions = JSON.parse(questions);

                // Replace autogenerated questions into sidebarQuestions
