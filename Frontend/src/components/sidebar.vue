            ...
            <aside id="sidebar"
                ...
                <div v-show="SidebarManager.isViewSelected('questions')"
                    ...
                    <SidebarQuestions
                        ...
                        @regenerateSampleQuestions="this.autogenerateSampleQuestions()"
        ...
        async autogenerateSampleQuestions() {
            try {
                const body = {store_in_history: false, user_query: "Based on your available tools, I want you to " +
                            "generate me exactly 5 requests or questions a user could give you. These 5 requests or " +
                ...
                const prevIdx = sidebarQuestions[Localizer.language].findIndex((obj) => obj.id === 'autogenerated-questions')
                if (prevIdx !== -1) {
                    body.user_query += "\n\nPlease do not generate the following questions:\n" +
                            JSON.stringify(sidebarQuestions[Localizer.language][prevIdx]["questions"]);
                }
                ...
                const newQuestions = {
                    ...
                    "icon": "🪄",
                    "questions": Object.values(parsedQuestions)
                }

                // Append or replace autogenerated questions into sidebarQuestions
                if (prevIdx === -1) {
    ...
    watch: {
        ...
        async connected(newVal) {
            if (newVal) {
                ...
                await this.autogenerateSampleQuestions() // Intentionally no await
