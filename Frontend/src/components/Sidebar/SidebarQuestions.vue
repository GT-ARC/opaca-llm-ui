    ...
    methods: {
        async autogenerateSampleQuestions(numQuestions = 5) {
            ...
            if (prevIdx === -1) {
                ...
                newQuestions.header = Localizer.samplePrompts[prevIdx].header;
                newQuestions.icon = Localizer.samplePrompts[prevIdx].icon;
            ...
            try {
                ...
                Localizer.samplePrompts.splice(prevIdx, 1);
            } finally {
        ...
        toggleSectionById(id, show = null) {
            const index = Localizer.samplePrompts.findIndex(section => section.id === id);
            this.toggleSection(index, show);
        },
