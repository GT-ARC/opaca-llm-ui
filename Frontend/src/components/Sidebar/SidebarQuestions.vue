            ...
            <div class="accordion-header text-center d-flex align-items-center" style="background-color: var(--background-color)">
                <button class="accordion-button collapsed text-center" type="button"
                    ...
                    <span class="float-end">
                        <i v-if="isEditModeActive && section.editable"
            ...
            <div :id="'questions-' + index"
                ...
                <div class="accordion-body">
                    ...
                    <div v-for="(q, qIndex) in section.questions"
                        ...
                        <i v-if="isEditModeActive && section.editable && section.id !== 'autogenerated-questions'"
                           class="fa fa-edit click-icon"
                           :class="{'disabled': !this.isEditingAllowed}"
                    ...
                    <div v-if="isEditModeActive && section.editable && section.id !== 'autogenerated-questions'"
...
export default {
    ...
    methods: {
        async autogenerateSampleQuestions(numQuestions = 5) {
            const autogenKey = 'autogenerated-questions';
            ...
            const prevQuestions = Localizer.getPrompts()[autogenKey];
            if (prevQuestions) {
                newQuestions.header = prevQuestions.header;
                newQuestions.icon = prevQuestions.icon;
            }
            Localizer.getPrompts()[autogenKey] = newQuestions;

            // Wait for initial push of questions and then show autogenerated questions
            await nextTick();
            this.expandSectionById(autogenKey);
            ...
            if (prevQuestions) {
                user_query += "\n\nPlease DO NOT generate the following questions:\n" +
                        JSON.stringify(prevQuestions.questions);
            }

            try {
                // Let backend generate user questions
                const response = await backendClient.queryNoChat("simple-tools", user_query, 30000);
                ...
                delete Localizer.getPrompts()[autogenKey];
            } finally {
        ...
        toggleSectionByHeader(header, show = null) {
            const index = Object.values(Localizer.getPrompts())
        ...
        async deleteCategory(category, index) {
            ...
            this.isEditingAllowed = false;
            delete Localizer.getPrompts()[category.id];
            await backendClient.savePrompts(Localizer.samplePrompts);
            this.isEditingAllowed = true;
        },
        ...
        async handleAddCategoryOk(values) {
            ...
            this.isEditingAllowed = false;
            Localizer.getPrompts()[values.header] = {
                id: values.header,
            ...
            const autogenCat = Localizer.getPrompts()['autogenerated-questions'];
            if (autogenCat) {
                delete Localizer.getPrompts()['autogenerated-questions'];
                Localizer.getPrompts()['autogenerated-questions'] = autogenCat;
            }
