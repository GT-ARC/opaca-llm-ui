...
<div class="container flex-grow-1 overflow-hidden overflow-y-auto">
    ...
    <div>
        ...
        <button class="btn btn-primary w-100 mt-3" type="button"
            ...
            {{ Localizer.get('sidebar_questions_regenerate')}}
        </button>
    ...
    methods: {
        async autogenerateSampleQuestions(numQuestions = 5) {
            ...
            const newQuestions = {
                ...
                header: Localizer.get('sidebar_questions_generated'),
                icon: "🪄",
                visible: true,
        ...
        async resetPrompts() {
            if (!confirm(Localizer.get('sidebar_questions_reset_confirm'))) return;
