...
export const localizationData = {
    GB: {
        ...
        files_textHandling_message: "Do you want text files to be inserted into the message or uploaded?",
    ...
    DE: {
        ...
        files_textHandling_message: "Möchten Sie Textdateien in die Nachricht eingefügen oder hochladen?",
