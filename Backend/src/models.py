...
class LLMConfig(BaseModel):
    ...
    reasoning_effort: Annotated[str, MethodConfig.string(default="low", options=["low", "medium", "high"], title="Reasoning Effort", description="How much reasoning should be applied to the model's output")]
